	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		view_account.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try{
					Class clickedClass = Class.forName("com.example.budgetnotebook.AccountActivity");
		...
		view_profile.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				try{
					Class clickedClass = Class.forName("com.example.budgetnotebook.ProfileActivity");
					Intent newIntent = new Intent(MainMenu.this, clickedClass);
					startActivity(newIntent);
					} catch(ClassNotFoundException e) {
						e.printStackTrace();
		...
		view_goals.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try{
					Class clickedClass = Class.forName("com.example.budgetnotebook.GoalActivity");
					Intent newIntent = new Intent(MainMenu.this, clickedClass);
					startActivity(newIntent);
					} catch(ClassNotFoundException e) {
						e.printStackTrace();
		...
		view_recommendations.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try{
					Class clickedClass = Class.forName("com.example.budgetnotebook.RecommendActivity");
					Intent newIntent = new Intent(MainMenu.this, clickedClass);
					startActivity(newIntent);
					} catch(ClassNotFoundException e) {
						e.printStackTrace();
